...
Across four domains (classification, regression, bandit, control), FW (det.) achieves strong reconstruction on the current benchmark: 0.819 accuracy (classification), $R^2 = 0.604$ (regression), $R^2 = 0.237$ (bandit), and $R^2 = 0.994$ (control).
